...
define(['angular'],function(angular){
    ...
    app.controller('GasRechargeCtrl',['$rootScope','$scope','$ionicModal','$state','$stateParams','$compile','$cookieStore','MessageService','ProductService','OrderService','MenuService',
        function($rootScope,$scope,$ionicModal,$state,$stateParams,$compile,$cookieStore,MessageService,ProductService,OrderService,MenuService){
...
//                    $scope.errorData.errorMsg = MessageService.errorMsg.commonMsg.query_gascard_error;
            ...
            $scope.cookieGasCard = function(gasCardNo){
                if($scope.checkHistoryNoList($scope.data.gasCardNo)){
