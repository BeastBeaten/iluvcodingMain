...
require(['angular','jquery', 'angular-ui-route','angular-cookie','./controller/market/custom/psb/psb-controller', './service/addons/market/custom/psb/psb-main-service-mobile', './routes/market/custom/psb/psb-routes','ionic'],
    function() {
        ...
        var module = angular.module('openwebApp', [
            'ui.router',
            'ngCookies',
            'openwebApp.psbRoutes',
            'openwebApp.psbService',
            'openwebApp.psbControllers',
            'ionic'
