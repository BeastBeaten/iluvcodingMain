...
require(['angular','jquery', 'angular-ui-route','angular-cookie','./controller/market/custom/psb/psb2-controller', './service/addons/market/custom/psb/psb2-main-service-mobile', './routes/market/custom/psb/psb2-routes','ionic'],
    function() {
        ...
        var module = angular.module('openwebApp', [
            'ui.router',
            'ngCookies',
            'openwebApp.psb2Routes',
            'openwebApp.psb2Service',
            'openwebApp.psb2Controllers',
            'ionic'
